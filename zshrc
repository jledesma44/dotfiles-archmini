...
# Aliases wifi connections==============================

alias wificonnect="~/.local/bin/wificonnect.zsh"
alias wifilist="nmcli device wifi list"
alias iphone12="~/.local/bin/iphone12.zsh"
alias ledesmafamily="~/.local/bin/ledesmafamily.zsh"
alias buchoo="~/.local/bin/buchoo.zsh"
...
# Start up Tmux session automatically when launching terminal=========================
